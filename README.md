...
Please see https://bmi-spec.readthedocs.io
for the latest information on the Python BMI.

```
[![Build Status](https://travis-ci.org/bmi-forum/bmi-python.svg?branch=master)](https://travis-ci.org/bmi-forum/bmi-python)
